...
pub const PROCESS_WORKFLOW_CONTRACT_VERSION: &str = "v3";
...
/// Strict invocation payload for process Workflow contract v3.
...
/// Provider-neutral invocation context visible to every Workflow v3 module.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(deny_unknown_fields)]
...
/// Strict terminal result envelope for process Workflow contract v3.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(deny_unknown_fields)]
