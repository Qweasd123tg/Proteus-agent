...
pub const PROCESS_WORKFLOW_CONTRACT_VERSION: &str = "v11";
...
/// Strict invocation payload for process Workflow contract v11.
...
/// Provider-neutral invocation context visible to every Workflow v11 module.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(deny_unknown_fields)]
...
/// Strict terminal result envelope for process Workflow contract v11.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
...
pub struct AgentWorkflowContext {
    ...
    pub tool_recorder: Arc<dyn ToolExecutionRecorder>,
    pub history_recorder: Arc<dyn WorkflowHistoryRecorder>,
    pub session_id: SessionId,
    pub thread_id: ThreadId,
    pub turn_id: TurnId,
    pub model_ref: ModelRef,
...
impl AgentWorkflowContext {
    ...
    pub fn new(
        ...
        Self {
            execution,
            tool_recorder: Arc::new(NoopToolExecutionRecorder),
            history_recorder: Arc::new(NoopWorkflowHistoryRecorder),
            session_id,
            thread_id,
            turn_id,
            model_ref,
    ...
    pub fn with_tool_recorder(mut self, recorder: Arc<dyn ToolExecutionRecorder>) -> Self {
