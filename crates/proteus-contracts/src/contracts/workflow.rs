...
pub const PROCESS_WORKFLOW_CONTRACT_VERSION: &str = "v10";
...
/// Strict invocation payload for process Workflow contract v10.
...
/// Provider-neutral invocation context visible to every Workflow v10 module.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(deny_unknown_fields)]
...
/// Strict terminal result envelope for process Workflow contract v10.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
