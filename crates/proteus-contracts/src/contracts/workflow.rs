...
pub const PROCESS_WORKFLOW_CONTRACT_VERSION: &str = "v12";
...
/// Strict invocation payload for process Workflow contract v12.
...
/// Provider-neutral invocation context visible to every Workflow v12 module.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(deny_unknown_fields)]
...
/// Strict terminal result envelope for process Workflow contract v12.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
