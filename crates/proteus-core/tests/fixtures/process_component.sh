...
printf '%s\n' "{\"jsonrpc\":\"2.0\",\"id\":$initialize_id,\"result\":{\"protocol_version\":\"v3\",\"component_id\":\"$component_id\",\"exports\":[{\"slot\":\"search\",\"module_id\":\"$search_id\",\"contract_version\":\"v2\",\"composition\":\"select_one\",\"module_features\":[]},{\"slot\":\"compactor\",\"module_id\":\"$compactor_id\",\"contract_version\":\"v7\",\"composition\":\"select_one\",\"module_features\":[]}]}}"
