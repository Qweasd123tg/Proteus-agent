"""Non-Rust model/v4 boundary fixture; all test behavior is export-configured."""
import os
import sys
import threading
import time
...
def initialize(params):
    ...
    for export in params["exports"]:
        if (export["slot"], export["contract_version"], export["composition"]) != ("model", "v4", "select_one"):
            raise ProtocolError("expected model/v4 select_one")
