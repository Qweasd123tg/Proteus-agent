...
printf '%s\n' "{\"jsonrpc\":\"2.0\",\"id\":$initialize_id,\"result\":{\"protocol_version\":\"v3\",\"component_id\":\"$component_id\",\"exports\":[{\"slot\":\"tool\",\"module_id\":\"$module_id\",\"contract_version\":\"v3\",\"composition\":\"ordered_many\",\"module_features\":[]}]}}"

while IFS= read -r request; do
    request_id=$(rpc_id "$request")
    case "$request" in
        *'"method":"list"'*)
            printf '%s\n' "{\"jsonrpc\":\"2.0\",\"id\":$request_id,\"result\":{\"result\":[{\"name\":\"detached_probe\",\"description\":\"Detached process tool architecture probe\",\"input_schema\":{\"type\":\"object\",\"properties\":{},\"additionalProperties\":false},\"surface\":{\"kind\":\"function\",\"strict\":false,\"output_schema\":null},\"safety\":\"ReadOnly\",\"supports_parallel_tool_calls\":true,\"timeout_ms\":3000,\"metadata\":{\"fixture\":true}}]}}"
            ;;
