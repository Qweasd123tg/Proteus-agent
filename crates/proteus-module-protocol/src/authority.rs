use proteus_contracts::contracts::{
    ...
    PROCESS_MODEL_DESCRIBE_METHOD, PROCESS_MODEL_STREAM_METHOD, PROCESS_PATCH_APPLY_METHOD,
    ...
    PROCESS_WORKFLOW_METHOD, ProcessModuleComposition, WORKFLOW_HOST_BUILD_CONTEXT_METHOD,
