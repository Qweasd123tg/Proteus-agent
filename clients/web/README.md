...
финальный markdown кэшируется по версии сообщения, а MathJax запускается только
для новых финальных сообщений с math-delimiters. Tool-карточки во время долгих
команд показывают elapsed time.
