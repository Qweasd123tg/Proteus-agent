    ...
    view! {
        <details class="config-builder-field config-editor">
            <summary class="config-editor-head">
                <crate::icons::Icon name="settings" size=16 class="config-editor-gear"/>
...
fn EditorRow(
    ...
    view! { <div class="config-editor-row" class:error=move || field_error.get().is_some()>
        ...
        <button type="button" class="config-editor-remove" title="Удалить параметр" aria-label="Удалить параметр" on:click=remove><crate::icons::Icon name="close" size=14/></button>
