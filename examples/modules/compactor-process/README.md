...
Worker использует общий component protocol v3 и compactor contract v8. Handshake
...
cargo run -p proteus-module-protocol --bin proteus-component-conformance -- \
  ...
  --export '{"slot":"compactor","module_id":"python_suffix","contract_version":"v8","module_config":{"trigger_messages":12,"retain_user_turns":2}}' \
