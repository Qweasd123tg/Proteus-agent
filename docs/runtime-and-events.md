...
Markdown дополнительно обрабатывается MathJax для LaTeX delimiters, а running
turn без pending input отображается compact working indicator. Turn остаётся
