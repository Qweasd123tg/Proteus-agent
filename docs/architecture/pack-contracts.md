...
| `WorkflowModelStreamCursor` / `WorkflowModelStreamItem` | workflow host | любые workflow exports | `workflow/v12`, один cursor на invocation, completed items до terminal, общий cancellation/cleanup и tool safety path |
