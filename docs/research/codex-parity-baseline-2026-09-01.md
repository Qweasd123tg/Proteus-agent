...
Статус: pinned baseline отдельной Codex reconstruction поверх Proteus. Эта
работа не задаёт цель или roadmap всей платформы и не является заявлением о
полной совместимости Proteus с Codex. Старый полный аудит от 2026-07-14
