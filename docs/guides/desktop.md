...
значение. Панели меняют ширину без анимации layout, а размеры записываются
после завершения перетаскивания. Композер занимает место в потоке и не закрывает
последние сообщения после изменения высоты. На узких экранах обзор закрывается
по фону или Escape.
