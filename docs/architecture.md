...
- `plugins/default/coding-workflow/src/lib.rs` - plugin-ready workflows под ids
  `coding.single_loop`, `coding.codex_loop` и `coding.plan_execute_review`.
